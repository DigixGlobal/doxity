...
exports.default = function (_ref) {
  ...
  var _JSON$parse = JSON.parse(_child_process2.default.execSync(exec)),
      sourceList = _JSON$parse.sourceList,
  ...
  Object.keys(contracts).forEach(function (contractName, i) {
    ...
    // get the source file
    var sourceFile = sourceList.find(function (fileName) {
    ...
    var data = _extends({}, devdoc, userdoc, {
      author: author,
      title: title,
      name: contractName,
      fileName: sourceFile,
      ...
      source: myWhitelist.source && _fs2.default.readFileSync(process.env.PWD + '/' + sourceFile).toString(),
